...
@Schema(description = "Response object for organisation address changes via sync")
data class SyncAddressResponse(
  @Schema(description = "The ID for this address", example = "111111")
  val organisationAddressId: Long,

  @Schema(description = "The organisation ID it is linked to", example = "1234")
  val organisationId: Long,

  @Schema(description = "Type of address", example = "HOME", nullable = true)
